...
import { TbMoodSmile } from 'react-icons/tb';
import { MdOutlineCheckCircle } from 'react-icons/md';
import { getDaycareById, getUser, getChildren, requestEnrollment, submitReview } from '../api/auth';
...
const SunshineAcademyPage = () => {
  ...
  // ── Facility status from real data ─────────────────────────────────────────
  const facilityStatus = {
    ...
    <>
      ...
      <div className="search-navbar">
        ...
        <div className="search-nav-right">
          ...
          <div className="search-user">
            <span className="search-user-name">
              {currentUser ? `${currentUser.first_name || ''} ${currentUser.last_name || ''}`.trim() || 'Parent' : 'Guest'}
